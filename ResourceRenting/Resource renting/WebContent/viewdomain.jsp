...
try{
   ...
   String name = null,siteowner=null,email=null;
   Connection con;
...
<img src="images/tit.png" alt="" width="720" />
  <div class="box_w220">
        ...
        <table align="center" width="691" style="border:1px solid #000000;">
          <tr bgcolor="#FFFFCC"> 
            <th width="150" height="48"><font color="#000000" size="3">EmailId</font></th>
            <th width="150"><font color="#000000" size="3">DomainName</font></th>
            <th width="150"><font color="#000000" size="3">HostingPlan</font></th>
            <th width="150"><font color="#000000"size="3">MemoryType</font></th>
			<th width="150"><font color="#000000" size="3">CompanyName</font></th>
          ...
          <tr> 
            <td height="49" bordercolor="#6699FF"> 
              <font color="#000000" size="3"><%=rs.getString("siteowner")%></font>
            </td>
            <td> 
             <font color="#000000" size="3"> <%=rs.getString("domainname")%></font>
             </td>
            <td> 
              <font color="#000000" size="3"><%=rs.getString("plan")%> days </font>
            </td>
            <td> 
             <font color="#000000" size="3"> <%=rs.getString("memory")%></font>
            </td>
			 <td> 
             <font color="#000000" size="3"> <%=rs.getString("companyname")%></font>
            </td>
			 <td> 
